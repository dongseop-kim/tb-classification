...
class RandomResizeCrop(DualTransform):
    ...
    def __init__(self, height, width, scale=0.2,
    ...
    def apply(self, img, scale, h_start=0, w_start=0,
    ...
    def apply_to_mask(self, img, scale,
                      h_start=0, w_start=0,
    ...
    def apply_to_bbox(self, bbox, scale,
                      pad_top=0, pad_bottom=0,
                      pad_left=0, pad_right=0,
                      rows=0, cols=0, **params):
    ...
    # not confirmed
    def apply_to_keypoint(self, keypoint, scale,
                          pad_top=0, pad_bottom=0,
